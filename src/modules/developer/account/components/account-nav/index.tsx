...
import { ArrowRightOnRectangle, BugAntSolid, PaperPlane, ChatBubbleLeftRight, BellAlert, House, StarSolid } from "@medusajs/icons"
import { usePathname } from "next/navigation"
import { useState } from "react"

import ChevronDown from "@modules/common/icons/chevron-down"
import LocalizedClientLink from "@modules/common/components/localized-client-link"
import { signoutDeveloper } from "@lib/data/developer"
    ...
    <>
      ...
      <div className="hidden small:flex flex-row relative" data-testid="account-nav">
        ...
        <div className="flex flex-col gap-y-4 pt-1">
          ...
          {/* Nav items — always visible, label slides in/out */}
